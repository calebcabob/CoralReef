...
public class ColorPickerPreference extends Preference {
    ...
    private void setTypeArray(TypedArray typedArray) {
        default_color = typedArray.getColor(R.styleable.ColorPickerPreference_default_color, Color.BLACK);
    ...
    protected void onBindView(View view) {
        ...
        colorBox.setBackgroundColor(getPreferenceManager().getSharedPreferences().getInt(getKey(), default_color));
    }
